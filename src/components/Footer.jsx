    ...
    return (
        <footer className="footer mt-50">
            <div className="container">
                <div className="row">
                    <div className="footer-col-1 col-md-3 col-sm-12"><a href="/frontend/"><img alt="jobBox" src="/images/jobhub-logo.svg" /></a>
                    ...
                    <div className="footer-col-6 col-md-3 col-sm-12">
                        ...
                        <div className="mt-15"><a className="mr-5" href="#"><img src="/images/app-store.png" alt="joxBox" /></a><a href="#"><img src="/images/android.png" alt="joxBox" /></a></div>
                    </div>
                </div>
